import os
     ...
     WEBHOOK_HOST = os.getenv('WEBHOOK_HOST', 'talkbubblesbot-production.up.railway.app')  # Публичный URL Railway
     ...
     if __name__ == '__main__':
         port = int(os.environ.get('PORT', 10000))  # Используем порт из Railway
