...
if not all([TELEGRAM_TOKEN, OPENROUTER_API_KEY, WEBHOOK_HOST]):
    raise ValueError("TELEGRAM_TOKEN, OPENROUTER_API_KEY и WEBHOOK_HOST должны быть заданы в .env")
...
if __name__ == "__main__":
    ...
    logging.info(f"Запуск на порту 10000, webhook: https://{WEBHOOK_HOST}/webhook")
